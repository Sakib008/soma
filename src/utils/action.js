...
const GET_SUGGESTED_USERS = 'user/suggested';
const GET_SEARCH_USERS = 'user/search';
const GET_USER_FOLLOWERS = 'user/followers';
const GET_USER_FOLLOWING = 'user/following';
const GET_USER_POSTS = 'user/posts';
const ADD_BOOKMARK = 'posts/add-bookmark';

export {ADD_BOOKMARK,GET_SEARCH_USERS,GET_SUGGESTED_USERS,GET_USER_FOLLOWERS,GET_USER_FOLLOWING,GET_ALL_POSTS,GET_BOOKMARK_POSTS,GET_LIKED_POSTS,GET_SUGGESSTED_POSTS,CREATE_POST,LIKE_POST,BOOKMARK_POST,EDIT_POSTS,DELETE_POSTS,ADD_USER_AVATAR,ADD_USER_BIO,ADD_USER_PORTFOLIO,FOLLOW_USER,UNFOLLOW_USER,USER_PROFILE,GET_ALL_USERS,GET_USER_POSTS}